...
} from "./chunk-B7J33KIV.js";
import {
  require_react_dom
} from "./chunk-MMW4JUSU.js";
import {
  require_prop_types
} from "./chunk-IO6EYNOD.js";
import {
  __toESM,
  require_react
...
var Slider = React44.forwardRef(function Slider2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime25.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime24.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime24.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min3 && mark.value <= max3).map((mark, index2) => {
...
function useAutocomplete(props) {
  ...
  const ignoreFocus = React63.useRef(false);
  const firstFocus = React63.useRef(true);
  const inputRef = React63.useRef(null);
  const listboxRef = React63.useRef(null);
  const [anchorEl, setAnchorEl] = React63.useState(null);
  const [focusedTag, setFocusedTag] = React63.useState(-1);
  const defaultHighlighted = autoHighlight ? 0 : -1;
  const highlightedIndexRef = React63.useRef(defaultHighlighted);
  ...
  const resetInputValue = React63.useCallback((event, newValue) => {
  ...
  const [inputPristine, setInputPristine] = React63.useState(true);
  ...
  const syncHighlightedIndex = React63.useCallback(() => {
    if (!popupOpen) {
      return;
    }
  ...
  const isTouch = React63.useRef(false);
